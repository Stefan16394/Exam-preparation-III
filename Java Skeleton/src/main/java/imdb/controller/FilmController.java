...
public class FilmController {
	...
	public String createProcess(Model model, FilmBindingModel filmBindingModel) {
		if (filmBindingModel.getName().equals("")||filmBindingModel.getDirector().equals("")
				||filmBindingModel.getGenre().equals("")||filmBindingModel.getYear()==0)
		{
			return "redirect:/";
		}

		Film film=new Film(filmBindingModel.getName(),filmBindingModel.getDirector(),
		filmBindingModel.getGenre(),filmBindingModel.getYear());
